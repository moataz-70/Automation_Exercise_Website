...
public class RegisterWhileCheckoutTests extends BaseTest
{
    ...
    {
        homePage.hoverOverProduct(6);
        homePage.clickAddToCart("Summer White Top");
        ...
        signup_LoginPage.signup_SetName("on");
        signup_LoginPage.signup_SetEmail("wwow@hotmail.com");
        ...
        Boolean isDisplayed = accountCreatedPage.isAccountCreatedVisible();

        var homePage = accountCreatedPage.clickContinueButton();
        Boolean isUserNameDisplayed = homePage.isLoggedInAsUserNameVisible();
    }
